...
class Test_SIMPLE_pimu(unittest.TestCase):
    ...
    def test_pimu_sensors(self):
        ...
        self.assertTrue(val_in_range('Cliff-0', p.status['cliff_range'][0], vmin=p.config['cliff_thresh'], vmax=100))
        self.assertTrue(val_in_range('Cliff-1', p.status['cliff_range'][1], vmin=p.config['cliff_thresh'], vmax=100))
        self.assertTrue(val_in_range('Cliff-2', p.status['cliff_range'][2], vmin=p.config['cliff_thresh'], vmax=100))
        self.assertTrue(val_in_range('Cliff-3', p.status['cliff_range'][3], vmin=p.config['cliff_thresh'], vmax=100))
